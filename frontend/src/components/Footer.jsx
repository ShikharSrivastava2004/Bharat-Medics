...
const Footer = () => {
  return (
    <div className='md:mx-10'>
      ...
      <div>
        <hr />
        <p className='py-5 text-sm text-center'>Copyright 2025 @BharatMedics - All Right Reserved.</p>
      </div>
